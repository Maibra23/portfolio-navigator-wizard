...
export const PortfolioComparisonTable: React.FC<
  PortfolioComparisonTableProps
> = ({
  ...
  const hasMarketOptimized =
    !!tripleOptimizationResults.market_optimized_portfolio;
  const recommendation =
    tripleOptimizationResults.optimization_metadata?.recommendation;

  return (
    <div
      className={`mt-6 pt-6 ${className}`}
      style={{ borderTop: `1px solid ${chartTheme.border}` }}
    >
      <h5
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          <p>
                            Explores the entire market to find the best stocks
                            and allocations, potentially replacing some of your
                            current holdings for better risk-adjusted returns.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
          ...
          <tbody>
                    ...
                    <div>
                      ...
                      {tripleOptimizationResults.comparison
                        ...
                        >
                          (
                          {tripleOptimizationResults.comparison
                            .market_vs_current.return_difference >= 0
                            ? "+"
                            : ""}
                          {formatPercent(
                            tripleOptimizationResults.comparison
                              .market_vs_current.return_difference,
                          )}
                          )
                        </span>
                      )}
            ...
            <tr className="border-b" style={{ borderColor: chartTheme.border }}>
              ...
              <td className="text-center py-3 px-2">
                ...
                >
                  {formatPercent(
                    tripleOptimizationResults.current_portfolio.metrics.risk,
                  )}
                </span>
              </td>
              <td className="text-center py-3 px-2">
                    ...
                    <div>
                      ...
                      {tripleOptimizationResults.comparison
                        ...
                        >
                          (
                          {tripleOptimizationResults.comparison
                            .market_vs_current.risk_difference <= 0
                            ? ""
                            : "+"}
                          {formatPercent(
                            tripleOptimizationResults.comparison
                              .market_vs_current.risk_difference,
                          )}
                          )
                        </span>
                      )}
                    ...
                    <div>
                      ...
                      {tripleOptimizationResults.comparison
                        ...
                        >
                          (
                          {tripleOptimizationResults.comparison
                            .market_vs_current.sharpe_difference >= 0
                            ? "+"
                            : ""}
                          {formatNumber(
                            tripleOptimizationResults.comparison
                              .market_vs_current.sharpe_difference,
                            { maxDecimals: 2 },
                          )}
                          )
                        </span>
            ...
            <tr className="border-b" style={{ borderColor: chartTheme.border }}>
              ...
              <td className="text-center py-3 px-2">
                ...
                >
                  {Object.entries(
                    tripleOptimizationResults.current_portfolio.weights || {},
                  )
                    .sort(([, a], [, b]) => (b as number) - (a as number))
                    .slice(0, 3)
                    .map(
                      ([ticker, weight]) =>
                        `${ticker}: ${formatPercent(weight as number)}`,
                    )
                    .join(", ") || "Equal"}
                </span>
              </td>
            ...
            <tr>
              ...
              <td className="text-center py-3 px-2">
                ...
                >
                  {tripleOptimizationResults.comparison.weights_vs_current
                    .risk_difference < 0 && <div>• Lower risk</div>}
                  {tripleOptimizationResults.comparison.weights_vs_current
                    .sharpe_difference > 0 && <div>• Better Sharpe</div>}
                  ...
                  <td className="text-center py-3 px-2">
                    ...
                    >
                      {tripleOptimizationResults.comparison.market_vs_current &&
                        tripleOptimizationResults.comparison.market_vs_current
                          .return_difference > 0 && <div>• Higher return</div>}
                      {tripleOptimizationResults.comparison.best_sharpe ===
                        "market" && <div>• Best Sharpe</div>}
            ...
            {showSelectionButtons && onPortfolioSelect && (
              <tr>
                <td colSpan={hasMarketOptimized ? 4 : 3} className="py-4 px-2">
                  <div
                    className={`grid gap-3 ${hasMarketOptimized ? "grid-cols-3" : "grid-cols-2"}`}
                  >
                    <Button
                      variant={
                        selectedPortfolio === "current" ? "default" : "outline"
                      }
                    ...
                    <Button
                      variant={
                        selectedPortfolio === "weights" ? "default" : "outline"
                      }
                    ...
                    {hasMarketOptimized && (
                      <Button
                        variant={
                          selectedPortfolio === "market" ? "default" : "outline"
                        }
